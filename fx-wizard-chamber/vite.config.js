...
export default defineConfig({
    ...
    plugins: [
        ...
        VitePWA({
            ...
            manifest: {
                name: 'FX Wizard Chamber',
                short_name: 'FX Wizard',
                description: 'Tune your synth sounds for Kastle 2 FX',
                theme_color: '#272727',
                screenshots: [
                    {
                        src: 'fx-wizard-chamber.png',
                        sizes: '1200x630',
                        type: 'image/png',
                        form_factor: 'wide',
                        label: 'FX Wizard Chamber',
                        platform: 'web'
                    },
                ],
                icons: [
